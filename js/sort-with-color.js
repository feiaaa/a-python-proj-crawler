...
function mergeSort(arr,options){
	...
	if(step)console.log(left,right)
	return merge(mergeSort(left,options),mergeSort(right,options)) 	
}
...
// 希尔排序=分组+组内插入排序+自动调节gap; 分组gap无限制，什么数字都可以，推荐递归的length-2
